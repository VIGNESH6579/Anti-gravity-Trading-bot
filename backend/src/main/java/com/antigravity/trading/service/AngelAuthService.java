...
public class AngelAuthService {
    ...
    public boolean login(LoginRequest request) {
        if (request.getApiKey() == null || request.getTotp() == null) {
            return false;
        }
        ...
        try {
            ...
            body.put("totp", request.getTotp()); // Using raw TOTP provided by the user
            ...
            if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
                ...
                if (data != null) {
                    ...
                    System.out.println("✅ Successfully Authenticated with Angel One SmartAPI using 6-digit TOTP!");
                    return true;
                }
            }
        } catch (Exception e) {
            System.err.println("❌ Failed to authenticate with Angel One. Error: " + e.getMessage());
        }
        return false;
    }
